...
const light: NodeDefinition = {
  ...
  properties: [
    ...
    // Ambient (0)
    { type: 'float', uniform: 'intensity', label: 'Intensity', min: 0, max: 5, step: 0.05, hardMax: 100, default: 0.5, visibleWhen: { uniform: 'mode', equal: 0 } },
    // Directional (1)
    { type: 'float', uniform: 'dirIntensity', label: 'Intensity', min: 0, max: 10, step: 0.1, hardMax: 100, default: 1, visibleWhen: { uniform: 'mode', equal: 1 } },
    ...
    // Point (2)
    { type: 'float', uniform: 'ptIntensity', label: 'Intensity', min: 0, max: 10, step: 0.1, hardMax: 100, default: 1, visibleWhen: { uniform: 'mode', equal: 2 } },
